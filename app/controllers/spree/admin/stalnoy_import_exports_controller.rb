      ...
      def api_put
        ...
        case params[:path]
          when 'country'
            ...
            json = base_json.first
            Spree::Country.create!(id: json['id'],
                                   'iso_name' => json['iso_name'],
                                   'iso' => json['iso'],
                                   'iso3' => json['iso3'],
                                   'name' => json['name'],
          ...
          when 'states'
            ...
            base_json.each_with_index do |h, i|
              ...
              Spree::State.create!(name: h['name'], abbr: h['abbr'], country_id: h['country_id'])
              response.stream.write "data: #{Hash['status' => 'work',
                                                  'action' => 'api_put',
                                                  'total' => base_json.count,
                                                  'last_row' => i + 1,
          ...
          when 'taxonomy'
            json = base_json.first
            Spree::Taxonomy.create!(id: json['id'], position: json['position'], name: json['name'])
            response.stream.write "data: #{Hash['status' => 'work',
                                                'action' => 'api_put',
                                                'total' => base_json.count,
                                                'last_row' => base_json.count,
            ...
            base_json.each_with_index do |h, i|
              ...
              if Spree::Taxon.exists?(id: a.parent_id) or a.parent_id.nil?
                ...
                r = Spree::Taxon.create(id: master['id'],
                                        ...
                                        icon_file_name: master['icon_file_name'],
                                        icon_content_type: master['icon_content_type'],
                                        icon_file_size: master['icon_file_size'],
                                        icon_updated_at: master['icon_updated_at'],
                                        name: master['name'],
